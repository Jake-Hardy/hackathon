...
$form->addElement('select', 'food', 'Food Default', $arrFood);
        $form->addRule('food', 'Please select a food option.', 'required');

$form->addElement('checkbox', 'hidefood', 'Hide Needed From SA' );

$form->addElement('select', 'toys', 'Toys Default', $arrToys);
        $form->addRule('toys', 'Please select a toys option.', 'required');

$form->addElement('checkbox', 'hidetoys', 'Hide Needed From TFT' );
...
if ($form->validate()) {
	...
	// Insert into database
        //$ret = Agency::insAgency($form->exportValues());
	$ret = Agency::insAgency($form->exportValue('name'),$form->exportValue('food'),$form->exportValue('toys'),is_checked($form->exportValue('hidefood')),is_checked($form->exportValue('hidetoys')));
