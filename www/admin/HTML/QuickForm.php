...
require_once 'QuickForm/select.php';
require_once 'QuickForm/text.php';
require_once 'QuickForm/hidden.php';
require_once 'QuickForm/input.php';
require_once 'QuickForm/autocomplete.php';
require_once 'QuickForm/textarea.php';
require_once 'QuickForm/checkbox.php';
require_once 'QuickForm/advcheckbox.php';
require_once 'QuickForm/submit.php';
/**
...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] = 
        array(
            'group'         =>array('QuickForm/group.php','HTML_QuickForm_group'),
            'hidden'        =>array('QuickForm/hidden.php','HTML_QuickForm_hidden'),
            'reset'         =>array('QuickForm/reset.php','HTML_QuickForm_reset'),
            'checkbox'      =>array('QuickForm/checkbox.php','HTML_QuickForm_checkbox'),
            'file'          =>array('QuickForm/file.php','HTML_QuickForm_file'),
            'image'         =>array('QuickForm/image.php','HTML_QuickForm_image'),
            'password'      =>array('QuickForm/password.php','HTML_QuickForm_password'),
            'radio'         =>array('QuickForm/radio.php','HTML_QuickForm_radio'),
            'button'        =>array('QuickForm/button.php','HTML_QuickForm_button'),
            'submit'        =>array('QuickForm/submit.php','HTML_QuickForm_submit'),
            'select'        =>array('QuickForm/select.php','HTML_QuickForm_select'),
            'hiddenselect'  =>array('QuickForm/hiddenselect.php','HTML_QuickForm_hiddenselect'),
            'text'          =>array('QuickForm/text.php','HTML_QuickForm_text'),
            'textarea'      =>array('QuickForm/textarea.php','HTML_QuickForm_textarea'),
            'link'          =>array('QuickForm/link.php','HTML_QuickForm_link'),
            'advcheckbox'   =>array('QuickForm/advcheckbox.php','HTML_QuickForm_advcheckbox'),
            'date'          =>array('QuickForm/date.php','HTML_QuickForm_date'),
            'static'        =>array('QuickForm/static.php','HTML_QuickForm_static'),
            'header'        =>array('QuickForm/header.php', 'HTML_QuickForm_header'),
            'html'          =>array('QuickForm/html.php', 'HTML_QuickForm_html'),
            'hierselect'    =>array('QuickForm/hierselect.php', 'HTML_QuickForm_hierselect'),
            'autocomplete'  =>array('QuickForm/autocomplete.php', 'HTML_QuickForm_autocomplete'),
            'xbutton'       =>array('QuickForm/xbutton.php','HTML_QuickForm_xbutton')
        );
...
$GLOBALS['_HTML_QuickForm_registered_rules'] = array(
    // 'required'      => array('html_quickform_rule_required', 'QuickForm/Rule/Required.php'),
    // 'maxlength'     => array('html_quickform_rule_range',    'QuickForm/Rule/Range.php'),
    // 'minlength'     => array('html_quickform_rule_range',    'QuickForm/Rule/Range.php'),
    // 'rangelength'   => array('html_quickform_rule_range',    'QuickForm/Rule/Range.php'),
    // 'email'         => array('html_quickform_rule_email',    'QuickForm/Rule/Email.php'),
    // 'regex'         => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'lettersonly'   => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'alphanumeric'  => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'numeric'       => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'nopunctuation' => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'nonzero'       => array('html_quickform_rule_regex',    'QuickForm/Rule/Regex.php'),
    // 'callback'      => array('html_quickform_rule_callback', 'QuickForm/Rule/Callback.php'),
    // 'compare'       => array('html_quickform_rule_compare',  'QuickForm/Rule/Compare.php')
    'required'      => array('html_quickform_rule_required', 'Rule/Required.php'),
    'maxlength'     => array('html_quickform_rule_range',    'Rule/Range.php'),
    'minlength'     => array('html_quickform_rule_range',    'Rule/Range.php'),
    'rangelength'   => array('html_quickform_rule_range',    'Rule/Range.php'),
    'email'         => array('html_quickform_rule_email',    'Rule/Email.php'),
    'regex'         => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'lettersonly'   => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'alphanumeric'  => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'numeric'       => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'nopunctuation' => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'nonzero'       => array('html_quickform_rule_regex',    'Rule/Regex.php'),
    'callback'      => array('html_quickform_rule_callback', 'Rule/Callback.php'),
    'compare'       => array('html_quickform_rule_compare',  'Rule/Compare.php')
);
...
class HTML_QuickForm extends HTML_Common
{
    ...
    */
    ...
    function validate()
    {
        ...
        include_once('QuickForm/RuleRegistry.php');
        $registry =& HTML_QuickForm_RuleRegistry::singleton();
        ...
        foreach ($this->_formRules as $rule) {
            if (true !== ($res = UW_call_user_func($rule, $this->_submitValues, $this->_submitFiles))) {
                if (is_array($res)) {
                    $this->_errors += $res;
                } else {
